...
radioMasculino=ttk.Radiobutton(frame_doctores,text="Mascuino",variable=genero,value="Masculino")
...
combohospital=ttk.Combobox(frame_doctores,values=["Hospital Central","Centro Sur","Clínica Norte"],textvariable=hospital)
